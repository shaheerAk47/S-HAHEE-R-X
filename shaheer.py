...
\033[1;91m--> GITHUB :- https://github.com/shaheerAk47/S-HAHEE-R-X
...
\033[1;91m--> GITHUB :- https://github.com/shaheerAk47/S-HAHEER
...
def login():        
	print "0.\033[1;93mExit           "
	pilih_login()
	
def pilih_login():
	peak = raw_input("\n\033[1;92mCHOOSE OPT :)  \033[1;92m")
	if peak =="":
		print "\x1b[1;92mFill correctly"
		pilih_login()
	elif peak =="1":
		login()
 elif peak =="2":
